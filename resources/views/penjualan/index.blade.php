...
<x-app-layout>
    ...
    <button class='float-right px-4 py-2 -mt-12 font-bold text-white bg-green-500 rounded-md hover:bg-green-600'>Tambah Penjualan</button>
    </a>
                        ...
                        <tbody class="">
                            ...
                            foreach($dataAll as $datax){
                                ...
                                <td class='flex justify-center gap-0'>
                                    <a href=/penjualan/update/".$datax->id_penjualan.">
                                    ...
                                    <a href=/penjualan/delete/".$datax->id_penjualan.">
